  ...
  <section class="home-section">
      ...
      <tbody>
        <?php
          ...
          $sentencia="SELECT * FROM tramite where Id_tramite not in (0)";
          
          $resultado=mysqli_query($conn,$sentencia);
          while($filas=mysqli_fetch_array($resultado))
          {
            echo "<tr>";
            echo "<td>"; echo $filas['Id_tramite']; echo "</td>";
            ...
            echo "<td> <a href='eliminar1.php?id=".$filas['Id_tramite']."''><button type='button' class='btn btn-danger'>Eliminar</button></a> </td>";
          }
        ?>
      </tbody>
    </table> 
