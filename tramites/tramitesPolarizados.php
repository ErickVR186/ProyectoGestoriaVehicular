<?php
	...
	$insertar3="SELECT `Precio_tramite` FROM `servicios` WHERE id_servicio=3";
	...
	$_SESSION['datos'] = 2;
	$_SESSION['trami'] = "tramitesPolarizados";
	...
	<section class="container forms">
		<div class="form login">
			<div class="form-content">
				<header>Permiso para Polarizados</header>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$('form').submit(function(e){
			...
			if((nombreC != "") && (telefono != "") && (idOficial.files.length > 0) && (FacVehi.files.length > 0) && (comprDomi.files.length > 0)){
				var valores = new FormData(formulario);
				valores.append('tramite', 'Permiso para Polarizados');
				$.ajax({								
									...
									$.ajax({
										...
										function(datos){
											...
											btnPDF.onclick = function(){
												window.open("../tickets.php?user="+nombreC+"&tram=Permiso para Polarizados.pdf");
											}
									        ...
									        btnsubmit.onclick = function(){
									            ...
									            var qrcode = new QRCode(qrfinal, {
									                text: "http://gestoriae.uptex-vsc2.com/tickets.php?user="+nombreC+"&tram=Permiso para Polarizados.pdf",
									                width: 200,
									                height: 200,
									                colorDark: "#000000",
									                colorLight: "#ffffff",
