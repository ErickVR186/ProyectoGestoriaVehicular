<?php
	...
	$insertar3="SELECT `Precio_tramite` FROM `servicios` WHERE id_servicio=4";
	...
	<section class="container forms">
		<div class="form login">
			<div class="form-content">
				<header>Permiso para Menores de Edad</header>
					...
					<div id="columnas">
						...
						<div id="columna2" class="columnsP">
							<div class="file input-file">
								...
								<input type="file" class="form-control form-control-sm" name="idOficial" id="idOficial">
							...
							<div class="file input-file">
								...
								<input type="file" class="form-control form-control-sm caja" name="ActNaci" id="ActNaci">
								<b id="tooltip1" class="tooltip1">
									<i class='bx bxs-help-circle'></i>
									<span class="tooltip1-box">Subir documentación en formato pdf</span>
								</b>
							...
							<div class="file input-file">
								...
								<input type="file" class="form-control form-control-sm caja" name="curp" id="curp">
								<b id="tooltip1" class="tooltip1">
									<i class='bx bxs-help-circle'></i>
									<span class="tooltip1-box">Subir documentación en formato pdf</span>
								</b>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$('form').submit(function(e){
			...
			var ActNaci = document.getElementById('ActNaci');
			...
			if ((idOficial.files.length == 0) || (ActNaci.files.length == 0) || (comprDomi.files.length == 0) || (curp.files.length == 0)) {
				swal('¡Atención!', 'Los archivos no han sido seleccionado.', 'error');
			}
			if((nombreC != "") && (telefono != "") && (idOficial.files.length > 0) && (ActNaci.files.length > 0) && (comprDomi.files.length > 0) && (curp.files.length > 0)){
				var valores = new FormData(formulario);
				valores.append('tramite', 'Permiso para Menores de Edad');
				$.ajax({								
									...
									$.ajax({
										...
										function(datos){
											...
											btnPDF.onclick = function(){
												window.open("../tickets.php?user="+nombreC+"&tram=Permiso para Menores de Edad.pdf");
											}
									        ...
									        btnsubmit.onclick = function(){
									            ...
									            var qrcode = new QRCode(qrfinal, {
									                text: "http://gestoriae.uptex-vsc2.com/tickets.php?user="+nombreC+"&tram=Permiso para Menores de Edad.pdf",
									                width: 200,
									                height: 200,
									                colorDark: "#000000",
									                colorLight: "#ffffff",
