<?php
	...
	$insertar3="SELECT `Precio_tramite` FROM `servicios` WHERE id_servicio=7";
	...
	$_SESSION['datos'] = 2;
	$_SESSION['trami'] = "tramitesCPropietario";
	...
	<section class="container forms">
		<div class="form login">
			<div class="form-content">
				<header>Cambio de Propietario</header>
	...
	$(document).ready(function(){
		$('form').submit(function(e){
			...
			if((nombreC != "") && (telefono != "") && (idOficial.files.length > 0) && (FacVehi.files.length > 0) && (comprDomi.files.length > 0)){
				...
				valores.append('tramite', 'Cambio de Propietario');
				$.ajax({								
									...
									$.ajax({
										...
										function(datos){
											...
											btnPDF.onclick = function(){
												window.open("../tickets.php?user="+nombreC+"&tram=Cambio de Propietario.pdf");
											}
									        ...
									        btnsubmit.onclick = function(){
									            ...
									            var qrcode = new QRCode(qrfinal, {
									                text: "http://gestoriae.uptex-vsc2.com/tickets.php?user="+nombreC+"&tram=Cambio de Propietario.pdf",
									                width: 200,
									                height: 200,
									                colorDark: "#000000",
									                colorLight: "#ffffff",
